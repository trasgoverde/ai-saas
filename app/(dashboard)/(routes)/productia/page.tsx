...
export default function ProjectPage() {
  ...
  return (
      ...
      <div className="max-w-3xl mx-auto p-4 bg-white rounded-lg shadow">
        <h1 className="text-3xl font-semibold">Unleash the Power of AI with DIPASSIO AI: Revolutionizing Copywriting, SEO, Email Generation, Content Generation, and PDF AI Chat</h1>
        ...
        <h2 className="text-xl font-semibold mt-6">What is DIPASSIO AI?</h2>
        <p className="text-gray-600">
        ...
        <h3 className="text-lg font-semibold mt-4">1. Copywriting with DIPASSIO AI: Elevating Creativity and Efficiency</h3>
        <p className="text-gray-600">
        ...
        <h3 className="text-lg font-semibold mt-4">2. SEO Dominance with DIPASSIO AI: Rank Higher, Faster</h3>
        <p className="text-gray-600">
        ...
        <h3 className="text-lg font-semibold mt-4">3. Email Generation Made Simple</h3>
        <p className="text-gray-600">
        ...
        <h3 className="text-lg font-semibold mt-4">4. Content Generation: Quality Content at Your Fingertips</h3>
        <p className="text-gray-600">
        ...
        <h3 className="text-lg font-semibold mt-4">5. PDF AI Chat: Interactive Documents for a Modern Audience</h3>
        <p className="text-gray-600">
        ...
        <h2 className="text-xl font-semibold mt-6">How DIPASSIO AI Works</h2>
        <p className="text-gray-600">
        ...
        <h2 className="text-xl font-semibold mt-6">Why Choose DIPASSIO AI?</h2>
        <ul className="list-disc list-inside text-gray-600 pl-6 mt-2">
          <li className="mb-2">**Unrivaled Efficiency:** DIPASSIO AI streamlines your content creation process, saving you time and effort.</li>
          <li className="mb-2">**Improved SEO:** Elevate your website's ranking in search engines with AI-optimized content.</li>
          <li className="mb-2">**Consistent Quality:** The tool ensures that your content maintains a high standard across all platforms.</li>
          <li className="mb-2">**Enhanced Engagement:** PDF AI Chat brings your static documents to life, engaging your audience like never before.</li>
        </ul>

        <h2 className="text-xl font-semibold mt-6">Harness the Power of DIPASSIO AI Today</h2>
        <p className="text-gray-600">
