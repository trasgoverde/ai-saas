...
welcome_message = """
# Welcome to the Taxonomy Builder Dipassio AI MoA (Mixture-of-Agents) interactive AI App!
...
def main(
    ...
    sleep(0.75)
    console.print(
        "\n[bold]To use this Ainfinity AI app, answer the questions below to get started [cyan](press enter to use the defaults)[/cyan][/bold]:"
    )
    ...
    while True:
        ...
        try:
            instruction = Prompt.ask(
                ...
                default="You are a Industrial Top Engineer and specialist in robotics, write an essay about the disruptive technologies and sensors, materials and capabilities that can be applied for surveillance and military applied robotics",
                show_default=True,
            )
        except EOFError:
            break
